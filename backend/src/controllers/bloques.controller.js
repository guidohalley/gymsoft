...
import { getAll as getAllBloques } from '../services/bloques.service.js'
import { validationResult } from 'express-validator';
import { mensajeError, mensajeExito } from '../utils/responseHandler.util.js';
import HTTP_STATUS from '../constants/httpStatusCodes.js';

const __fileName = 'bloques.controller.js';
const model = 'Bloque';
...
const getAll = async (req, res,next) => {
    try {
        ...
        const {activo, descripcion,page = 1, limit = 10 } = req.query;

        const datos = await getAllBloques(gimnasioId,{
            descripcion,
